    ...
    buildLoginOverlay() {
      ...
      o.innerHTML =
        ...
        '<div id="login-tab" style="display:flex;gap:8px;justify-content:center;margin-bottom:10px">' +
          '<button class="acc-btn sm" id="tab-login" onclick="Account.switchLoginTab(' + String.fromCharCode(39) + 'login' + String.fromCharCode(39) + ')">登录</button>' +
          '<button class="acc-btn sm gray" id="tab-reg" onclick="Account.switchLoginTab(' + String.fromCharCode(39) + 'reg' + String.fromCharCode(39) + ')">注册</button>' +
        '</div>' +
       ...
       '<button class="acc-btn" id="login-submit" style="width:100%" onclick="Account.submitAuth()">登录</button>' +
